...
class Stateczek extends Statek{
    ...
    int masa_j;
     ...
     public void stWyl(String nazwa_lad, int liczba){
        int remove,masa_tmp,liczba_tmp;
        for(int i = 0; i < tow.size(); i++) {
            //System.out.println("iteracja"+i);
            if(tow.get(i).getLiczba()==liczba){
	...
	public static void main(String[] args) throws FileNotFoundException{
	    ...
	    switch(nr){
	        case 1:{
        	    ...
        	    Statek s3=new Statek("dar mlodzierzy",300);
	        ...
	        case 2:{
	            ...
	            System.out.println("Całkowita masa towarow na stateczkach: "+st1.ile_st+" kg");
	            break;
	        }
	        case 3:{
